...
- Production HKDF-SHA-256/HMAC-SHA-256 implementation details and non-secret test vectors; the primitive decisions are selected, but execution remains absent.
