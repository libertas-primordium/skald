...
This pass does not add an executable KAT. It does not add a KAT runner or KAT executor. A future executable KAT requires a separate explicitly approved branch.
