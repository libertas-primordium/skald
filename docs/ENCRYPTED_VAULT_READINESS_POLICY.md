...
- Android Argon2id calibration evidence capture with high-end-only Pixel evidence, low/mid/release-like/thermal blockers, explicit MiB units, positive elapsed timing, repeated timing summaries, and secret-like field rejection,
