...
- `DisabledVaultCryptoProvider` reports the provider boundary and provider-level KAT contract modeled but rejects KDF, AEAD, key generation, keyset storage, and persistence operations.
