...
Except for the separate commonTest-only inert marker, inert inventory, inert profile, inert validation report, and inert reachability proof, these artifacts remain future-only and do not authorize current implementation.
