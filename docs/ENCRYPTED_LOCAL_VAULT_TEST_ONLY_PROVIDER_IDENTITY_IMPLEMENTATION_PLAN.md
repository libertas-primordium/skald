...
Except for the separate commonTest-only inert marker, inert inventory, inert profile, inert validation report, inert reachability proof, and inert capability matrix, these artifacts remain future-only and do not authorize current implementation.
