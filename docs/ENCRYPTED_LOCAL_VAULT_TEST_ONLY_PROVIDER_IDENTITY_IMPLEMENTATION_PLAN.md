...
Except for the separate commonTest-only inert marker, inert inventory, and inert profile, these artifacts remain future-only and do not authorize current implementation.
