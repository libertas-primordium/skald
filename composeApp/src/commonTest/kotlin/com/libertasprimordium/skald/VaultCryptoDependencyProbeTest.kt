...
class VaultCryptoDependencyProbeTest {
    ...
    fun selectedSplitStackIsReviewedCandidateOnly() {
        ...
        assertContains(selected.capabilities, VaultCryptoDependencyCapability.RedactionLeakageBoundaryImplementedTested)
        assertContains(selected.capabilities, VaultCryptoDependencyCapability.RedactionLeakageFailureVocabularyModeled)
        assertContains(selected.capabilities, VaultCryptoDependencyCapability.PassphrasePolicyBoundaryImplementedTested)
        assertContains(selected.capabilities, VaultCryptoDependencyCapability.PassphrasePolicyFailureVocabularyModeled)
        assertContains(selected.capabilities, VaultCryptoDependencyCapability.ClearWipeStrategyBoundaryImplementedTested)
        assertContains(selected.capabilities, VaultCryptoDependencyCapability.ClearWipeFailureVocabularyModeled)
        assertContains(selected.capabilities, VaultCryptoDependencyCapability.MigrationCorruptionBoundaryImplementedTested)
        assertContains(selected.capabilities, VaultCryptoDependencyCapability.MigrationCorruptionFailureVocabularyModeled)
        assertContains(selected.capabilities, VaultCryptoDependencyCapability.ProviderOperationAuthorizationBoundaryImplementedTested)
        assertContains(selected.capabilities, VaultCryptoDependencyCapability.ProviderOperationFailureVocabularyModeled)
        assertContains(selected.capabilities, VaultCryptoDependencyCapability.RuntimeRandomnessAuthorizationBoundaryImplementedTested)
        assertContains(selected.capabilities, VaultCryptoDependencyCapability.RuntimeRandomnessFailureVocabularyModeled)
        assertContains(selected.capabilities, VaultCryptoDependencyCapability.KdfCalibrationAuthorizationBoundaryImplementedTested)
        assertContains(selected.capabilities, VaultCryptoDependencyCapability.KdfCalibrationAuthorizationFailureVocabularyModeled)
        assertContains(selected.capabilities, VaultCryptoDependencyCapability.SecureStorageAuthorizationBoundaryImplementedTested)
        assertContains(selected.capabilities, VaultCryptoDependencyCapability.SecureStorageAuthorizationFailureVocabularyModeled)
        assertContains(selected.capabilities, VaultCryptoDependencyCapability.UnlockAuthorizationBoundaryImplementedTested)
        ...
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.RedactionLeakageBoundaryStillDisabled)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.RedactionLeakageRuntimeReviewMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.PassphrasePolicyBoundaryStillDisabled)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.PassphrasePolicyRuntimeReviewMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.ClearWipeStrategyBoundaryStillDisabled)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.ClearWipeStrategyRuntimeReviewMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.MigrationCorruptionBoundaryStillDisabled)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.MigrationCorruptionRuntimeReviewMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.MigrationCorruptionTestsMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.ProviderOperationAuthorizationBoundaryStillDisabled)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.ProviderOperationAuthorizationRuntimeReviewMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.ProviderOperationAuthorizationTestsMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.RuntimeRandomnessAuthorizationBoundaryStillDisabled)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.RuntimeRandomnessAuthorizationRuntimeReviewMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.RuntimeRandomnessAuthorizationTestsMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.KdfCalibrationAuthorizationBoundaryStillDisabled)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.KdfCalibrationAuthorizationRuntimeReviewMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.KdfCalibrationAuthorizationTestsMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.SecureStorageAuthorizationBoundaryStillDisabled)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.SecureStorageAuthorizationRuntimeReviewMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.SecureStorageAuthorizationTestsMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.UnlockAuthorizationBoundaryStillDisabled)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.UnlockAuthorizationRuntimeReviewMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.UnlockAuthorizationTestsMissing)
