...
class VaultCryptoDependencyProbeTest {
    ...
    fun selectedSplitStackIsReviewedCandidateOnly() {
        ...
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.ProviderLevelKatStrategyContractOnly)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.RandomizedAeadBehavioralKatExecutionMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.IntegratedVerificationOrderKatExecutionMissing)
        ...
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.VaultHeaderCommitmentProviderIntegrationMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.HkdfSha256KeyExpansionProviderIntegrationMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.HmacSha256HeaderCommitmentProviderIntegrationMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.KeyExpansionOutputLayoutProviderIntegrationMissing)
        ...
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.StrictAadProviderIntegrationMissing)
        assertContains(selected.blockers, VaultCryptoDependencyBlocker.TinkRecordAeadProviderIntegrationMissing)
