...
class VaultCryptoAndroidKatValidationTest {
    @Test
    fun bouncyCastleArgon2idMatchesRfc9106PublicVectorOnAndroidRuntime() {
    ...
    @Test
    fun tinkXChaCha20Poly1305MatchesXChaChaDraftPublicVectorOnAndroidRuntime() {
        ...
        assertArrayEquals(expectedCiphertextAndTag, ciphertextAndTag)
        assertArrayEquals(plaintext, aead.decrypt(nonce, ciphertextAndTag, aad))
    }
