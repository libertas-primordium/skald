...
class VaultCryptoTestProviderKatHarnessTest {
    private val provider = TinkBouncyCastleTestVaultCryptoProvider(
        runtimeCoverageVectorId = VaultCryptoProviderKatVectorId.DesktopProviderRuntimeCoverage,
    )

    @Test
    fun desktopTestProviderRunsPositiveKatsThroughSkaldInterface() {
    ...
    @Test
    fun desktopTestProviderRunsNegativeMisuseKatsThroughSkaldInterface() {
    ...
    @Test
    fun desktopTestProviderRunsPolicyAndRedactionKatsThroughSkaldInterface() {
    ...
    @Test
    fun testProviderDoesNotEnableProductionOperationsOrStorageApproval() {
    ...
    @Test
    fun disabledProviderDoesNotPassProviderLevelKats() {
    ...
    @Test
    fun katHarnessEvidenceAndDiagnosticsAreRedacted() {
        ...
        val combined = listOf(
            success.toString(),
            assertIs<VaultCryptoProviderResult.Success<VaultCryptoProviderKatEvidence>>(success).value.toString(),
            blocked.toString(),
            assertIs<VaultCryptoProviderResult.Blocked>(blocked).error.toString(),
            assertIs<VaultCryptoProviderResult.Blocked>(blocked).error.diagnostic.toString(),
        ).joinToString("\n")
...
private class TinkBouncyCastleTestVaultCryptoProvider(
    ...
    private fun xChaChaVector(): XChaChaPublicVector =
        XChaChaPublicVector(
            key = hexToBytes(
...
private data class XChaChaPublicVector(
    val key: ByteArray,
    val nonce: ByteArray,
    val aad: ByteArray,
