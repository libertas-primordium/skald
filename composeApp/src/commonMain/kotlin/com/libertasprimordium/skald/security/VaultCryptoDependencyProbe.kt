...
enum class VaultCryptoDependencyCapability(val label: String) {
    ...
    SecureStorageAuthorizationBoundaryImplementedTested(
    ...
    CreationAuthorizationBoundaryImplementedTested(
        "vault creation authorization boundary implemented and tested",
    ),
    CreationAuthorizationFailureVocabularyModeled(
        "vault creation authorization failure vocabulary modeled",
    ),
    AuthorizationReadinessMatrixImplementedTested(
        "vault authorization/readiness matrix implemented and tested",
    ),
    AuthorizationReadinessMatrixFailureVocabularyModeled(
        "vault authorization/readiness matrix failure vocabulary modeled",
    ),
    ProviderCandidatePackagingBoundaryImplementedTested(
        "provider candidate packaging boundary implemented and tested",
    ),
    ProviderCandidatePackagingFailureVocabularyModeled(
        "provider candidate packaging failure vocabulary modeled",
    ),
...
enum class VaultCryptoDependencyBlocker(val label: String) {
    ...
    SecureStorageAuthorizationRuntimeReviewMissing(
    ...
    CreationAuthorizationRuntimeReviewMissing("runtime creation authorization review missing"),
    CreationAuthorizationTestsMissing("creation authorization tests missing"),
    AuthorizationReadinessMatrixStillDisabled(
        "vault authorization/readiness matrix remains model-only",
    ),
    AuthorizationReadinessMatrixRuntimeReviewMissing(
        "runtime authorization/readiness matrix review missing",
    ),
    AuthorizationReadinessMatrixTestsMissing("authorization/readiness matrix tests missing"),
    ProviderCandidatePackagingBoundaryStillDisabled(
        "provider candidate packaging boundary remains model-only",
    ),
    ProviderCandidatePackagingRuntimeReviewMissing(
        "runtime provider candidate packaging review missing",
    ),
    ProviderCandidatePackagingTestsMissing("provider candidate packaging tests missing"),
