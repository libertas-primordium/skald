...
enum class VaultCryptoDependencyCapability(val label: String) {
    ...
    KnownAnswerVectorReviewRequired("known-answer vector review required"),
    ...
    fun currentSpikeResults(): List<VaultCryptoDependencyProbeResult> =
        listOf(
            VaultCryptoDependencyProbeResult(
                ...
                note = "Selected only for Android/Linux compile and packaging feasibility. It is not wired into vault storage.",
            ),
            VaultCryptoDependencyProbeResult(
