...
object BitcoinWalletSyncStatusUiMapper {
    ...
    private fun blockerText(blocker: BitcoinWalletSyncBlocker): String =
        when (blocker) {
            ...
            BitcoinWalletSyncBlocker.EncryptedVaultUnavailable -> "Encrypted vault readiness is unavailable."
    ...
    private fun warningText(warning: BitcoinWalletSyncWarning): String =
        when (warning) {
            ...
            BitcoinWalletSyncWarning.EncryptedVaultUnavailable -> "Encrypted vault implementation is unavailable."
            BitcoinWalletSyncWarning.EncryptedVaultReadinessOnly -> "Encrypted vault readiness is policy-only."
