...
- Production observation persistence is explicitly deferred until encrypted vault or equivalent approved secure metadata storage exists. Observed addresses, UTXOs, labels, transaction notes, backend metadata, address index state, and wallet history are sensitive wallet metadata and are not persisted by this scaffold.
