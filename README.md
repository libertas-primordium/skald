...
The test-only BDK regtest UTXO scan validation boundary is opt-in and desktop-test-only. It currently verifies the safe blocked state requiring a local indexed scan backend:
