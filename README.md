...
- `docs/PRODUCTION_SYNC_SERVICE_BOUNDARY.md` records the disabled production sync service facade. It is a policy/model document only; it does not enable production wallet sync, backend clients, observation persistence, receive UI, signing, broadcasting, public endpoints, or mainnet.
